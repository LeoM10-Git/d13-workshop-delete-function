...
public class ContactController {
    ...
    /*    inject the bean*/
    /*comment out the get env method, directly use the given directory, just to test the delete method*/
    private Contacts utilContacts;
    public ContactController(Contacts utilContacts) {
        this.utilContacts = utilContacts;
    }
